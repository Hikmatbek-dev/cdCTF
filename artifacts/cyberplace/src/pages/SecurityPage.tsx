          ...
          <li key={session.id} className="flex items-center justify-between gap-3 p-3 bg-muted/40 rounded-xl">
            <div className="min-w-0">
              <div className="font-bold text-sm flex items-center gap-2">
                ...
                {session.isCurrent && (
                  <span className="text-xs font-black uppercase bg-primary/15 text-primary px-2 py-0.5 rounded-full shrink-0">
          ...
          <li key={entry.id} className="flex items-center justify-between gap-3 p-3 bg-muted/40 rounded-xl text-sm">
            <div className="min-w-0">
              <div className="flex items-center gap-2">
                ...
                {entry.suspicious && (
                  <span className="text-xs font-black uppercase bg-amber-500/15 text-amber-600 dark:text-amber-400 px-2 py-0.5 rounded-full">
